...
class CmsController extends Controller
{
    ...
    public function resourceDetail($slug){
        try {
            ...
            $blog = Blog::with('category:id,name')->select('id','category_id','user_id','title', 'content', 'short_description', 'image', 'slug', 'created_at','content')->where(['slug'=>$slug,'status'=>1])->first();
