...
Route::middleware('checkAuthToken')->group(function () {
    ...
    Route::get('/save-quiz-answer-progress',[QuizController::class,'saveQuizAnswerProgress']);
    ...
    Route::get('invoice-detail/{subscription_id}',[StudentController::class,'invoiceDetail']);
});
