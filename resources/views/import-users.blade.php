   ...
   <div class="bg-white dark:bg-box-dark m-0 p-0 text-body dark:text-subtitle-dark text-[15px] rounded-10 relative h-full">
      <div class="p-[25px]">
         ...
         <div class="flex items-center justify-center w-full">
            <label for="import-file" class="flex flex-col items-center justify-center w-full sm:min-h-[280px] bg-white dark:bg-box-dark mb-[30px] mx-auto p-2.5 rounded-[10px] border-2 border-dashed border-[#c6d0dc] dark:border-box-dark-up hover:border-primary dark:hover:border-primary cursor-pointer transition-all duration-300 ease-linear">
               <div class="flex flex-col items-center justify-center pt-5 pb-6">
                  <div class="text-[70px] text-light dark:text-subtitle-dark">
                     <i class="uil uil-export"></i>
                  </div>
                  <p class="text-[20px] font-medium text-dark dark:text-title-dark">Drop File or <a class="text-primary" href="#">Browse</a></p>
               </div>
