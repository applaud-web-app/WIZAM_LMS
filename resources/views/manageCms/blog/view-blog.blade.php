        ...
        <div class="grid grid-cols-12 gap-5">
            <div class="col-span-12">
                ...
                <div
                    ...
                    <!-- Title -->
                    <h4 class="capitalize text-[20px] text-dark dark:text-title-dark font-semibold">All Blogs</h4>
    ...
    <script>
        $(document).ready(function() {
            $('#blog-table').DataTable({
                processing: true,
                serverSide: true,
                ajax: '{{ route('view-blog') }}', // Ensure this route matches your route name
                columns: [{
                        data: 'DT_RowIndex',
                        name: 'DT_RowIndex',
                        orderable: false,
