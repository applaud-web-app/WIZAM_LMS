...
@section('content')
    ...
    <section class="mx-[12px] lg:mx-[30px] min-h-[calc(100vh-195px)] mb-[30px] ssm:mt-[30px] mt-[15px]">
        ...
        <div class="grid grid-cols-12 gap-5">
            <div class="col-span-12">
                ...
                <div
                    ...
                    <!-- Title -->
                    <h4 class="capitalize text-[20px] text-dark dark:text-title-dark font-semibold">All Pages</h4>
                        ...
                        <nav>
                            <ol class="flex flex-wrap p-0 mb-0 list-none gap-[8px] max-sm:justify-center">
                                ...
                                <li class="inline-flex items-center before:content-[''] before:w-1 before:h-1 before:ltr:float-left rtl:float-right before:bg-light-extra before:me-[7px] before:pe-0 before:rounded-[50%]"
                                    aria-current="page">
                                    <span
                                        class="text-[14px] font-normal leading-[20px] flex items-center capitalize text-light dark:text-subtitle-dark">All
                                        Pages</span>
                                </li>
                            </ol>
                        </nav>
        ...
        <div
            ...
            <div
                class="px-[25px] text-dark dark:text-title-dark font-medium text-[17px] flex flex-wrap items-center justify-between  max-sm:h-auto border-b border-regular dark:border-box-dark-up">
                <h1
    ...
    <script>
        $(document).ready(function() {
            $('#blog-table').DataTable({
                processing: true,
                serverSide: true,
                ajax: '{{ route('view-pages') }}', // Ensure this route matches your route name
                columns: [{
                        data: 'DT_RowIndex',
                        name: 'DT_RowIndex',
                        orderable: false,
