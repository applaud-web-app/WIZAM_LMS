    ...
    <div class="grid grid-cols-12 gap-[25px] mb-[30px]">
        <div class="col-span-12 md:col-span-12">
            <div class="bg-white dark:bg-box-dark m-0 p-0 text-body dark:text-subtitle-dark text-[15px] rounded-10 relative">
                <div class="p-[25px]">
                    <form action="{{route('store-user-details')}}" method="POST" class="ssm:grid ssm:grid-cols-12 max-ssm:flex-col max-ssm:flex gap-[15px]" id="addUser" enctype="multipart/form-data">
                        @csrf
                        <!-- Title -->
