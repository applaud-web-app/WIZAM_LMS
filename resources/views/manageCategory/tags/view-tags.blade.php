...
@section('content')
    ...
    <section class="mx-[12px] lg:mx-[30px] min-h-[calc(100vh-195px)] mb-[30px] ssm:mt-[30px] mt-[15px]">
        ...
        <div class="grid grid-cols-12 gap-5">
            <div class="col-span-12">
                ...
                <div
                    ...
                    <!-- Title -->
                    <h4 class="capitalize text-[20px] text-dark dark:text-title-dark font-semibold">Tags</h4>
                        ...
                        <nav>
                            <ol class="flex flex-wrap p-0 mb-0 list-none gap-[8px] max-sm:justify-center">
                                ...
                                <li class="inline-flex items-center before:content-[''] before:w-1 before:h-1 before:ltr:float-left rtl:float-right before:bg-light-extra before:me-[7px] before:pe-0 before:rounded-[50%]"
                                    aria-current="page">
                                    <span
                                        class="text-[14px] font-normal leading-[20px] flex items-center capitalize text-light dark:text-subtitle-dark">Tags</span>
                                </li>
                            </ol>
                        </nav>
                    </div>
        ...
        <div
            ...
            <div
                ...
                <h1
                    class="mb-0 inline-flex items-center py-1 overflow-hidden whitespace-nowrap text-ellipsis text-[18px] font-semibold text-dark dark:text-title-dark ">
                    List of Tags</h1>
                <button type="button"
                    class="flex items-center px-[14px] text-sm text-white rounded-md bg-primary border-primary h-10 gap-[6px] transition-[0.3s]"
                    data-te-toggle="modal" data-te-target="#tagsModal" data-te-ripple-init data-te-ripple-color="light">
                    <i class="uil uil-plus"></i>
                    <span class="m-0">Add tags</span>
                </button>
            </div>
    ...
    <div data-te-modal-init
        ...
        id="tagsModal" tabindex="-1" aria-labelledby="tagsModalLabel" aria-hidden="true">
        <form method="POST" action="{{route('add-tags')}}" data-te-modal-dialog-ref
            class="pointer-events-none relative w-auto translate-y-[-50px] opacity-0 transition-all duration-300 ease-in-out min-[576px]:mx-auto min-[576px]:mt-7 min-[576px]:max-w-[500px]" id="addTags">
            @csrf
            <div
                ...
                <div class="relative flex-auto p-4" data-te-modal-body-ref>
                    ...
                    <div class="mb-[15px]">
                        ...
                        <div class="flex flex-col flex-1 ">
                            <input type="text" id="tagsName" name="tag_name" required
                        ...
                        <div class="flex flex-wrap items-center gap-[10px]">
                            ...
                            <div class="mb-[0.125rem] mr-4 inline-block min-h-[1.5rem] pl-[1.5rem]">
                                <input
                                    ...
                                    type="radio" name="tag_status" id="tag_status" value="1"
                                    autocompleted="" checked>
                                <label class="mt-px inline-block pl-[0.15rem] hover:cursor-pointer"
                                    for="tag_status">Enable</label>
                            </div>
                            <!--Second radio-->
                            <div class="mb-[0.125rem] mr-4 inline-block min-h-[1.5rem] pl-[1.5rem]">
                                <input
                                    class="relative ltr:float-left rtl:float-right -ms-[1.5rem] me-1 mt-0.5 h-[18px] w-[18px] appearance-none rounded-full border-1 border-solid border-normal before:pointer-events-none before:absolute before:h-4 before:w-4 before:scale-0 before:rounded-full before:bg-transparent before:opacity-0 before:shadow-[0px_0px_0px_13px_transparent] before:content-[''] after:absolute after:z-[1] after:block after:h-4 after:w-4 after:rounded-full after:content-[''] checked:border-primary checked:before:opacity-[0.16] checked:after:absolute checked:after:left-1/2 checked:after:top-1/2 checked:after:h-[0.625rem] checked:after:w-[0.625rem] checked:after:rounded-full checked:after:border-primary checked:after:bg-primary checked:after:content-[''] checked:after:[transform:translate(-50%,-50%)] hover:cursor-pointer hover:before:opacity-[0.04] hover:before:shadow-[0px_0px_0px_13px_rgba(0,0,0,0.6)] dark:border-neutral-600 dark:checked:border-primary dark:checked:after:border-primary dark:checked:after:bg-primary"
                                    type="radio" name="tag_status" id="tag_status" value="0"
                                    autocompleted="">
                                <label class="mt-px inline-block pl-[0.15rem] hover:cursor-pointer"
                                    for="tag_status">Disable</label>
                            </div>
     ...
     <form method="POST" data-te-modal-dialog-ref
         class="pointer-events-none relative w-auto translate-y-[-50px] opacity-0 transition-all duration-300 ease-in-out min-[576px]:mx-auto min-[576px]:mt-7 min-[576px]:max-w-[500px]" id="editTags">
         @csrf
         <div
             class="min-[576px]:shadow-[0_0.5rem_1rem_rgba(#000, 0.15)] pointer-events-auto relative flex w-full flex-col rounded-md border-none bg-white bg-clip-padding text-current shadow-lg outline-none dark:bg-neutral-600">
             <div
      ...
      $(document).ready(function(){
           ...
           $(document).on('click', '#confirmDelete', function(){
            ...
            $(document).on('click', '.editItem', function() {
               ...
               // Update form fields
               form.find('input[name="tag_name"]').val(name);
               
                // Set radio button based on status
                form.find('input[name="tag_status"]').each(function() {
