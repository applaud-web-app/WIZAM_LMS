...
@section('content')
    ...
    <section class="mx-[30px] min-h-[calc(100vh-195px)] mb-[30px] ssm:mt-[30px] mt-[15px]">
        ...
        <div
            ...
            <div class="p-[25px]">
                <form action="{{route('update-fib-details',['id'=>$question->id])}}" method="POST" enctype="multipart/form-data">
                    @csrf
                    ...
                    <div class="mb-[20px]">
                        ...
                        <textarea id="question" name="question" rows="2" required
                            ...
                            placeholder="Enter the question. Wrap the word or phrase you want as a blank with ## (e.g., The capital of France is ##Paris##).">@isset($question){{$question->question}}@endisset</textarea>
                    </div>
