...
<section class="mx-[12px] lg:mx-[30px] min-h-[calc(100vh-195px)] mb-[30px] ssm:mt-[30px] mt-[15px]">
   ...
   <div class="bg-white dark:bg-box-dark m-0 p-0 text-body dark:text-subtitle-dark text-[15px] rounded-10 relative h-full">
      ...
      <div class="p-[25px]">
         <form action="{{route('save-mtf-details')}}" method="POST" enctype="multipart/form-data">
            @csrf
            <!-- Skill Level -->
            <div class="mb-[20px]">
            ...
            <!-- Add More Button -->
            <div class="mb-[20px]">
               <button type="button" id="addMorePairs" class="px-[14px] text-sm text-white rounded-md bg-secondary border-secondary h-10 gap-[6px] transition-[0.3s]"><i class="uil uil-plus"></i></button>
            </div>
