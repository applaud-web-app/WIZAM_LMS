               ...
               <nav>
                  <ol class="flex flex-wrap p-0 mb-0 list-none gap-[8px] max-sm:justify-center">
                     ...
                     <li class="inline-flex items-center before:content-[''] before:w-1 before:h-1 before:ltr:float-left rtl:float-right before:bg-light-extra before:me-[7px] before:pe-0 before:rounded-[50%]" aria-current="page">
                        <span class="text-[14px] font-normal leading-[20px] flex items-center capitalize text-light dark:text-subtitle-dark">Add Video</span>
                     </li>
                  </ol>
               </nav>
            </div>
   ...
   <div class="grid grid-cols-12 gap-[20px]">
      <div class="col-span-12">
         ...
         <div class="bg-white dark:bg-box-dark p-7 shadow-pricing dark:shadow-none rounded-10">
            <form action="{{route('store-video')}}" method="POST" enctype="multipart/form-data" class="grid grid-cols-12 gap-[25px]" id="videoForm">
               @csrf
               <!-- Video Title -->
               <div class="col-span-12">
                  ...
                  <input type="text" name="video_title" id="video_title" class="w-full px-4 py-3 rounded-4 border-normal border-1 dark:bg-box-dark-up dark:border-box-dark-up text-body dark:text-subtitle-dark" placeholder="Enter video title" required>
               </div>
               ...
               <div class="col-span-12">
                  <ul class="flex flex-row flex-wrap pl-0 mb-5 list-none border-b-0" role="tablist" data-te-nav-ref>
                     <li role="presentation">
                        <a href="#tabs-messages-one" class="block border-x-0 border-b-2 border-t-0 border-transparent px-3 py-2  text-14 font-normal capitalize leading-tight text-dark hover:isolate hover:border-transparent focus:isolate focus:border-transparent data-[te-nav-active]:border-primary data-[te-nav-active]:text-primary dark:text-neutral-400 dark:hover:bg-transparent dark:data-[te-nav-active]:border-primary-400 dark:data-[te-nav-active]:text-primary-400" data-te-toggle="pill" data-te-target="#tabs-messages-one" data-te-nav-active role="tab" aria-controls="tabs-messages-one" aria-selected="true">MP4 Video</a>
                     </li>
                     <li role="presentation">
                        <a href="#tabs-home-one" class="block border-x-0 border-b-2 border-t-0 border-transparent px-3 py-2 me-4 text-14 font-normal capitalize leading-tight text-dark hover:isolate hover:border-transparent focus:isolate focus:border-transparent data-[te-nav-active]:border-primary data-[te-nav-active]:text-primary dark:text-neutral-400 dark:hover:bg-transparent dark:data-[te-nav-active]:border-primary-400 dark:data-[te-nav-active]:text-primary-400" data-te-toggle="pill" data-te-target="#tabs-home-one"  role="tab" aria-controls="tabs-home-one" aria-selected="false">Youtube Video</a>
                     </li>
                     <li role="presentation">
                        <a href="#tabs-profile-one" class="block border-x-0 border-b-2 border-t-0 border-transparent px-3 py-2 me-4 text-14 font-normal capitalize leading-tight text-dark hover:isolate hover:border-transparent focus:isolate focus:border-transparent data-[te-nav-active]:border-primary data-[te-nav-active]:text-primary dark:text-neutral-400 dark:hover:bg-transparent dark:data-[te-nav-active]:border-primary-400 dark:data-[te-nav-active]:text-primary-400" data-te-toggle="pill" data-te-target="#tabs-profile-one" role="tab" aria-controls="tabs-profile-one" aria-selected="false">Vimeo Video</a>
                     </li>
                  </ul>

                  <!--Tabs content-->
                  <div class="mb-[18px]">
                     <div class="hidden opacity-0 text-breadcrumbs text-14 transition-opacity duration-150 ease-linear data-[te-tab-active]:block" id="tabs-home-one" role="tabpanel" aria-labelledby="tabs-home-tab" >
                        <input type="text" name="youtube_id" id="youtube_id" class="w-full px-4 py-3 rounded-4 border-normal border-1 dark:bg-box-dark-up dark:border-box-dark-up text-body dark:text-subtitle-dark" placeholder="Enter YouTube Id">
                     </div>
                     <div class="hidden opacity-0 transition-opacity text-breadcrumbs text-14 duration-150 ease-linear data-[te-tab-active]:block" id="tabs-profile-one" role="tabpanel" aria-labelledby="tabs-profile-tab">
                        <input type="text" name="vimeo_id" id="vimeo_id" class="w-full px-4 py-3 rounded-4 border-normal border-1 dark:bg-box-dark-up dark:border-box-dark-up text-body dark:text-subtitle-dark" placeholder="Enter Vimeo Id">
                     </div>
                     <div class="hidden opacity-100 transition-opacity text-breadcrumbs text-14 duration-150 ease-linear data-[te-tab-active]:block" id="tabs-messages-one" role="tabpanel" aria-labelledby="tabs-profile-tab" data-te-tab-active >
                        <input type="url" name="video_url" id="video_url" class="w-full px-4 py-3 rounded-4 border-normal border-1 dark:bg-box-dark-up dark:border-box-dark-up text-body dark:text-subtitle-dark" placeholder="Enter Video Link">
                     </div>
                  </div>
               </div>
               ...
               <div class="col-span-12">
                  ...
                  <textarea name="description" id="description" rows="4" class="summernote w-full px-4 py-3 rounded-4 border-normal border-1 dark:bg-box-dark-up dark:border-box-dark-up text-body dark:text-subtitle-dark" placeholder="Enter a short description"></textarea>
               </div>
               ...
               <div class="col-span-12 md:col-span-6">
                  ...
                  <input type="number" name="watch_time" id="watch_time" class="w-full px-4 py-3 rounded-4 border-normal border-1 dark:bg-box-dark-up dark:border-box-dark-up text-body dark:text-subtitle-dark" placeholder="Enter watch time in minutes" value="1" min="1" required>
               </div>
