                    ...
                    <div class="p-[25px]">
                        <form action="{{route('update-settings')}}" method="POST" autocomplete="off" enctype="multipart/form-data" id="addSetting">
                           @csrf
                            ...
                            <div class="mb-[15px]">
                                <label for="seoDescription"
                                    class="inline-flex items-center w-[178px] mb-[10px] text-sm font-medium capitalize text-body dark:text-title-dark">Copyright Text <span class="text-red-500">*</span></label>
                                <div class="flex flex-col flex-1 ">
